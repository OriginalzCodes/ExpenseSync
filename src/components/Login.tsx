...
import { Mail, Phone, Lock, ArrowRight, Fingerprint, Github } from 'lucide-react';
    ...
    <div className="min-h-screen bg-neu-base pt-12 px-6 flex flex-col relative">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 flex-1">
        ...
        <div className="flex justify-end">
          <button type="button" className="text-[10px] font-bold text-blue-400 tracking-wider uppercase hover:underline">
            Forgot Password?
          </button>
        </div>
        ...
        <button 
          type="submit"
          className="w-full neu-button-blue text-white rounded-2xl py-4 font-bold text-lg flex items-center justify-center gap-2 transition-all active:scale-[0.98]"
        >
          Sign In
